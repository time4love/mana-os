...
Every claim is a fractal **Mini-Arena**. The community uses AI to generate counter-claims; a successful logical strike degrades the parent claim's **Validity Health Bar**, dynamically altering the balance of evidence in the overarching Macro-Arena. The AI acts as a blind, objective referee of formal logic. Community members ingest transcripts of videos or articles, which the AI breaks down into individual logical claims. Users then debate the AI, providing counter-evidence. If a sub-claim successfully defeats its parent claim logically, the score dynamically "bubbles up," altering the credibility of the entire macro-topic. Truth is determined by structural integrity, not popularity.
